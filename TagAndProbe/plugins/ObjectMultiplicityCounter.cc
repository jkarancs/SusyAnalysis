...
typedef ObjectMultiplicityCounter<reco::Jet>    JetMultiplicityCounter;
typedef ObjectMultiplicityCounter<pat::Jet>    PatJetMultiplicityCounter;

#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(JetMultiplicityCounter);
DEFINE_FWK_MODULE(PatJetMultiplicityCounter);
