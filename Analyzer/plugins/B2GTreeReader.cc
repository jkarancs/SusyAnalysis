...
public:
  ...
  void Load_Tree(TFile &f, const char* name = "DMTreesDumper/TreeBase") {
    ...
    tree_->GetBranch("jets_size")->SetAddress(&data.jetAK4.jets_size);
    tree_->GetBranch("jetE")->SetAddress(&data.jetAK4.jetE);
    tree_->GetBranch("jetPt")->SetAddress(&data.jetAK4.jetPt);
    tree_->GetBranch("jetMass")->SetAddress(&data.jetAK4.jetMass);
    tree_->GetBranch("jetEta")->SetAddress(&data.jetAK4.jetEta);
    tree_->GetBranch("jetPhi")->SetAddress(&data.jetAK4.jetPhi);
    tree_->GetBranch("jetPartonFlavour")->SetAddress(&data.jetAK4.jetPartonFlavour);
    tree_->GetBranch("jetPhi")->SetAddress(&data.jetAK4.jetPhi);
    tree_->GetBranch("jetCSV")->SetAddress(&data.jetAK4.jetCSV);
    tree_->GetBranch("jetCSVV1")->SetAddress(&data.jetAK4.jetCSVV1);
    tree_->GetBranch("jetCharge")->SetAddress(&data.jetAK4.jetCharge);
    tree_->GetBranch("jetChargeMuEnergy")->SetAddress(&data.jetAK4.jetChargeMuEnergy);
    tree_->GetBranch("jetChargedHadronMultiplicity")->SetAddress(&data.jetAK4.jetChargedHadronMultiplicity);
    tree_->GetBranch("jetElectronEnergy")->SetAddress(&data.jetAK4.jetElectronEnergy);
    tree_->GetBranch("jetGenJetCharge")->SetAddress(&data.jetAK4.jetGenJetCharge);
    tree_->GetBranch("jetGenJetE")->SetAddress(&data.jetAK4.jetGenJetE);
    tree_->GetBranch("jetGenJetEta")->SetAddress(&data.jetAK4.jetGenJetEta);
    tree_->GetBranch("jetGenJetPhi")->SetAddress(&data.jetAK4.jetGenJetPhi);
    tree_->GetBranch("jetGenJetPt")->SetAddress(&data.jetAK4.jetGenJetPt);
    tree_->GetBranch("jetGenJetY")->SetAddress(&data.jetAK4.jetGenJetY);
    tree_->GetBranch("jetGenPartonCharge")->SetAddress(&data.jetAK4.jetGenPartonCharge);
    tree_->GetBranch("jetGenPartonE")->SetAddress(&data.jetAK4.jetGenPartonE);
    tree_->GetBranch("jetGenPartonEta")->SetAddress(&data.jetAK4.jetGenPartonEta);
    tree_->GetBranch("jetGenPartonPhi")->SetAddress(&data.jetAK4.jetGenPartonPhi);
    tree_->GetBranch("jetGenPartonPt")->SetAddress(&data.jetAK4.jetGenPartonPt);
    tree_->GetBranch("jetGenPartonY")->SetAddress(&data.jetAK4.jetGenPartonY);
    tree_->GetBranch("jetHFEMEnergy")->SetAddress(&data.jetAK4.jetHFEMEnergy);
    tree_->GetBranch("jetHFEMMultiplicity")->SetAddress(&data.jetAK4.jetHFEMMultiplicity);
    tree_->GetBranch("jetHFHadronEnergy")->SetAddress(&data.jetAK4.jetHFHadronEnergy);
    tree_->GetBranch("jetHFHadronMultiplicity")->SetAddress(&data.jetAK4.jetHFHadronMultiplicity);
    tree_->GetBranch("jetHLTjetDeltaR")->SetAddress(&data.jetAK4.jetHLTjetDeltaR);
    tree_->GetBranch("jetHLTjetE")->SetAddress(&data.jetAK4.jetHLTjetE);
    tree_->GetBranch("jetHLTjetEta")->SetAddress(&data.jetAK4.jetHLTjetEta);
    tree_->GetBranch("jetHLTjetPt")->SetAddress(&data.jetAK4.jetHLTjetPt);
    tree_->GetBranch("jetHLTjetPhi")->SetAddress(&data.jetAK4.jetHLTjetPhi);
    tree_->GetBranch("jetHadronFlavour")->SetAddress(&data.jetAK4.jetHadronFlavour);
    tree_->GetBranch("jetIsCSVL")->SetAddress(&data.jetAK4.jetIsCSVL);
    tree_->GetBranch("jetIsCSVM")->SetAddress(&data.jetAK4.jetIsCSVM);
    tree_->GetBranch("jetIsCSVT")->SetAddress(&data.jetAK4.jetIsCSVT);
    tree_->GetBranch("jetSmearedE")->SetAddress(&data.jetAK4.jetSmearedE);
    tree_->GetBranch("jetSmearedPt")->SetAddress(&data.jetAK4.jetSmearedPt);
    tree_->GetBranch("jetSmearedPEta")->SetAddress(&data.jetAK4.jetSmearedPEta);
    tree_->GetBranch("jetSmearedPhi")->SetAddress(&data.jetAK4.jetSmearedPhi);
    tree_->GetBranch("jetJERup")->SetAddress(&data.jetAK4.jetJERup);
    tree_->GetBranch("jetJERdown")->SetAddress(&data.jetAK4.jetJERdown);
    tree_->GetBranch("jetY")->SetAddress(&data.jetAK4.jetY);
    tree_->GetBranch("jetelectronMultiplicity")->SetAddress(&data.jetAK4.jetelectronMultiplicity);
    tree_->GetBranch("jetmuonMultiplicity")->SetAddress(&data.jetAK4.jetmuonMultiplicity);
    tree_->GetBranch("jetneutralHadronMultiplicity")->SetAddress(&data.jetAK4.jetneutralHadronMultiplicity);
    tree_->GetBranch("jetneutralMultiplicity")->SetAddress(&data.jetAK4.jetneutralMultiplicity);
    tree_->GetBranch("jetphotonMultiplicity")->SetAddress(&data.jetAK4.jetphotonMultiplicity);
    tree_->GetBranch("jetsCorrPt")->SetAddress(&data.jetAK4.jetsCorrPt);
    tree_->GetBranch("jetsCorrEta")->SetAddress(&data.jetAK4.jetsCorrEta);
    tree_->GetBranch("jetsCorrPhi")->SetAddress(&data.jetAK4.jetsCorrPhi);
    tree_->GetBranch("jetsCorrE")->SetAddress(&data.jetAK4.jetsCorrE);
    tree_->GetBranch("jetsCorrMass")->SetAddress(&data.jetAK4.jetsCorrMass);
    tree_->GetBranch("jetsCorrNJets")->SetAddress(&data.jetAK4.jetsCorrNJets);
    tree_->GetBranch("jetsCorrPartonFlavour")->SetAddress(&data.jetAK4.jetsCorrPartonFlavour);
    ...
    tree_->GetBranch("jetAK8tau1")->SetAddress(&data.jetAK8.jetAK8tau1);
    tree_->GetBranch("jetAK8tau2")->SetAddress(&data.jetAK8.jetAK8tau2);
    tree_->GetBranch("jetAK8tau3")->SetAddress(&data.jetAK8.jetAK8tau3);
    tree_->GetBranch("jetAK8trimmedMass")->SetAddress(&data.jetAK8.jetAK8trimmedMass);
    tree_->GetBranch("jetAK8prunedMass")->SetAddress(&data.jetAK8.jetAK8prunedMass);
    tree_->GetBranch("jetAK8filteredMass")->SetAddress(&data.jetAK8.jetAK8filteredMass);
