...
public:
  ...
  void Load_Tree(TFile &f, const char* name = "B2GTTreeMaker/B2GTree") {
    ...
    set_branch_("jetAK8_subjetIndex0", &data.jetsAK8.subjetIndex0, 1);
    set_branch_("jetAK8_subjetIndex1", &data.jetsAK8.subjetIndex1, 1);
    set_branch_("jetAK8_subjetIndex2", &data.jetsAK8.subjetIndex2, 1);
    set_branch_("jetAK8_subjetIndex4", &data.jetsAK8.subjetIndex3, 1);
    ...
    set_branch_("jetsCmsTopTag_size", &data.jetsCmsTopTag.size, 1);
    set_branch_("jetsCmsTopTag_Mass", &data.jetsCmsTopTag.Mass, 1);			
    set_branch_("jetsCmsTopTag_Pt", &data.jetsCmsTopTag.Pt, 1);
    set_branch_("jetsCmsTopTag_Eta", &data.jetsCmsTopTag.Eta, 1);
    set_branch_("jetsCmsTopTag_Y", &data.jetsCmsTopTag.Y, 0);
    set_branch_("jetsCmsTopTag_Phi", &data.jetsCmsTopTag.Phi, 1);
    set_branch_("jetsCmsTopTag_E", &data.jetsCmsTopTag.E, 1);
    set_branch_("jetsCmsTopTag_Charge", &data.jetsCmsTopTag.Charge, 0);
    set_branch_("jetsCmsTopTag_CSV", &data.jetsCmsTopTag.CSV, 1);
    set_branch_("jetsCmsTopTag_CSVV1", &data.jetsCmsTopTag.CSVV1, 1);
    set_branch_("jetsCmsTopTag_GenPartonY", &data.jetsCmsTopTag.GenPartonY, 0);
    set_branch_("jetsCmsTopTag_GenPartonEta", &data.jetsCmsTopTag.GenPartonEta, 0);
    set_branch_("jetsCmsTopTag_GenPartonPhi", &data.jetsCmsTopTag.GenPartonPhi, 0);
    set_branch_("jetsCmsTopTag_GenPartonPt", &data.jetsCmsTopTag.GenPartonPt, 0);
    set_branch_("jetsCmsTopTag_GenPartonE", &data.jetsCmsTopTag.GenPartonE, 0);
    set_branch_("jetsCmsTopTag_GenPartonCharge", &data.jetsCmsTopTag.GenPartonCharge, 0);
    set_branch_("jetsCmsTopTag_PartonFlavour", &data.jetsCmsTopTag.PartonFlavour, 0);
    set_branch_("jetsCmsTopTag_HadronFlavour", &data.jetsCmsTopTag.HadronFlavour, 0);
    set_branch_("jetsCmsTopTag_GenJetY", &data.jetsCmsTopTag.GenJetY, 0);
    set_branch_("jetsCmsTopTag_GenJetEta", &data.jetsCmsTopTag.GenJetEta, 0);
    set_branch_("jetsCmsTopTag_GenJetPhi", &data.jetsCmsTopTag.GenJetPhi, 0);
    set_branch_("jetsCmsTopTag_GenJetPt", &data.jetsCmsTopTag.GenJetPt, 0);
    set_branch_("jetsCmsTopTag_GenJetE", &data.jetsCmsTopTag.GenJetE, 0);
    set_branch_("jetsCmsTopTag_GenJetCharge", &data.jetsCmsTopTag.GenJetCharge, 0);
    set_branch_("jetsCmsTopTag_muonMultiplicity", &data.jetsCmsTopTag.muonMultiplicity, 0);
    set_branch_("jetsCmsTopTag_PhotonEnergy", &data.jetsCmsTopTag.PhotonEnergy, 0);
    set_branch_("jetsCmsTopTag_ElectronEnergy", &data.jetsCmsTopTag.ElectronEnergy, 0);
    set_branch_("jetsCmsTopTag_MuonEnergy", &data.jetsCmsTopTag.MuonEnergy, 0);
    set_branch_("jetsCmsTopTag_HFHadronEnergy", &data.jetsCmsTopTag.HFHadronEnergy, 0);
    set_branch_("jetsCmsTopTag_HFEMEnergy", &data.jetsCmsTopTag.HFEMEnergy, 0);
    set_branch_("jetsCmsTopTag_ChargedHadronMultiplicity", &data.jetsCmsTopTag.ChargedHadronMultiplicity, 0);
    set_branch_("jetsCmsTopTag_numberOfDaughters", &data.jetsCmsTopTag.numberOfDaughters, 0);
    set_branch_("jetsCmsTopTag_chargedMultiplicity", &data.jetsCmsTopTag.chargedMultiplicity, 0);
    set_branch_("jetsCmsTopTag_neutralHadronMultiplicity", &data.jetsCmsTopTag.neutralHadronMultiplicity, 0);
    set_branch_("jetsCmsTopTag_neutralHadronEnergy", &data.jetsCmsTopTag.neutralHadronEnergy, 0);
    set_branch_("jetsCmsTopTag_neutralEmEnergy", &data.jetsCmsTopTag.neutralEmEnergy, 0);
    set_branch_("jetsCmsTopTag_chargedEmEnergy", &data.jetsCmsTopTag.chargedEmEnergy, 0);
    set_branch_("jetsCmsTopTag_chargedHadronEnergy", &data.jetsCmsTopTag.chargedHadronEnergy, 0);
    set_branch_("jetsCmsTopTag_photonMultiplicity", &data.jetsCmsTopTag.photonMultiplicity, 0);
    set_branch_("jetsCmsTopTag_electronMultiplicity", &data.jetsCmsTopTag.electronMultiplicity, 0);
    set_branch_("jetsCmsTopTag_HFHadronMultiplicity", &data.jetsCmsTopTag.HFHadronMultiplicity, 0);
    set_branch_("jetsCmsTopTag_HFEMMultiplicity", &data.jetsCmsTopTag.HFEMMultiplicity, 0);
    set_branch_("jetsCmsTopTag_ChargeMuEnergy", &data.jetsCmsTopTag.ChargeMuEnergy, 0);
    set_branch_("jetsCmsTopTag_neutralMultiplicity", &data.jetsCmsTopTag.neutralMultiplicity, 0);
    set_branch_("jetsCmsTopTag_jecFactor0", &data.jetsCmsTopTag.jecFactor0, 0);
    set_branch_("jetsCmsTopTag_jetArea", &data.jetsCmsTopTag.jetArea, 0);
    set_branch_("jetsCmsTopTag_SmearedPt", &data.jetsCmsTopTag.SmearedPt, 0);
    set_branch_("jetsCmsTopTag_SmearedPEta", &data.jetsCmsTopTag.SmearedPEta, 0);
    set_branch_("jetsCmsTopTag_SmearedPhi", &data.jetsCmsTopTag.SmearedPhi, 0);
    set_branch_("jetsCmsTopTag_SmearedE", &data.jetsCmsTopTag.SmearedE, 0);
    set_branch_("jetsCmsTopTag_JERup", &data.jetsCmsTopTag.JERup, 0);
    set_branch_("jetsCmsTopTag_JERdown", &data.jetsCmsTopTag.JERdown, 0);
    set_branch_("jetsCmsTopTag_subjetIndex0", &data.jetsCmsTopTag.subjetIndex0, 0);
    set_branch_("jetsCmsTopTag_subjetIndex1", &data.jetsCmsTopTag.subjetIndex1, 0);
    set_branch_("jetsCmsTopTag_subjetIndex2", &data.jetsCmsTopTag.subjetIndex2, 0);
    set_branch_("jetsCmsTopTag_subjetIndex4", &data.jetsCmsTopTag.subjetIndex3, 0);
    set_branch_("jetsCmsTopTag_tau1", &data.jetsCmsTopTag.tau1, 0);
    set_branch_("jetsCmsTopTag_tau2", &data.jetsCmsTopTag.tau2, 0);
    set_branch_("jetsCmsTopTag_tau3", &data.jetsCmsTopTag.tau3, 0);
    set_branch_("jetsCmsTopTag_trimmedMass", &data.jetsCmsTopTag.trimmedMass, 0);
    set_branch_("jetsCmsTopTag_prunedMass", &data.jetsCmsTopTag.prunedMass, 0);
    set_branch_("jetsCmsTopTag_filteredMass", &data.jetsCmsTopTag.filteredMass, 0);
    set_branch_("jetsCmsTopTag_topMass", &data.jetsCmsTopTag.topMass, 0);
    set_branch_("jetsCmsTopTag_wMass", &data.jetsCmsTopTag.wMass, 0);
    set_branch_("jetsCmsTopTag_nSubJets", &data.jetsCmsTopTag.nSubJets, 0);
    set_branch_("jetsCmsTopTag_minmass", &data.jetsCmsTopTag.minmass, 0);
    ...
    set_branch_("evt_MR", &data.jetsAK8.MR, 1);
    set_branch_("evt_MTR", &data.jetsAK8.MTR, 1);
    set_branch_("evt_R", &data.jetsAK8.R, 1);
    set_branch_("evt_R2", &data.jetsAK8.R2, 1);
